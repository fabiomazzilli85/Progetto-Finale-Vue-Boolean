        ...
        <section class="bg-white pd-bottom-section">
            ...
            <div class="flex-article">
                <div class="card-article">
                    <img src="../assets/news1-1-223x223.png" alt="">
                    <p class="color-text">29.05.2022</p>
                    <h2 class="color-text">What Is Football?</h2>
                    <p class="color-text text-width">Football is a sport that is know as a ball game and loved by[...]
                    </p>
                ...
                <div class="card-article">
                    ...
                    <p class="color-text text-width">Football; it is an aerobic-based anareobic sport in which jumps,
                        kicks, turns [...]</p>
                    <button class="more-button">More</button>
                </div>

                <div class="card-article">
                    <img src="../assets/news4-1-223x223.png" alt="">
                    <p class="color-text">29.05.2022</p>
